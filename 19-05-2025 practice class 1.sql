-- similar values or similar data ko ek sath leke aana h to group by use m lete h
-- calculation perfrom krne k liye aggregate function use m lete h 
-- 2 tabel k beech m connection banane k liye  help krta ho foreign key
-- 2 alg alg tables se data nikalne k liye joins use m liya jata h 
use sakila;
CREATE TABLE orders (
